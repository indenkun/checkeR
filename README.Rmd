...
`{checkeR}` is an add-in package for RStudio that checks for updates to R and RStudio.
...
"Checks a newer version of R" is a wrapper for `check.for.updates.R()` of the `{installr}`.
